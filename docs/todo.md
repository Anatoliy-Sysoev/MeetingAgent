...
- [x] MA-RESOLVED-SPEAKER-TURNS (#296, parent #285): merge adjacent resolved
  utterances under a gap/overlap/source policy while preserving source IDs,
  bounded UI expansion and TXT/Markdown views.
...
- [ ] SEC-P0-GIT-HISTORY-PURGE (#167): verified backup, full rewrite and
  branch/tag force-push are complete; Support ticket #4593146 is open; close
  after GitHub removes internal pull-request refs and cached commit views.

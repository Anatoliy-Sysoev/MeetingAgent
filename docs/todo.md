...
- [x] MA-PRIVACY-RUNTIME-HARDENING (#162): anonymization/report privacy, meeting index path redaction, public-safe preflight errors, atomic job last_error writes, readiness status fix, Workspace media DOM hygiene.

...
Диаграммы технических файлов, вызовов, объектов и QH-поведения вынесены в отдельный документ:
...
- не переносить Docker/Yandex запуск на другой ПК без актуального health/smoke и runtime-пакета `data/asu_june_bot_ntk` или плана пересборки корпуса.

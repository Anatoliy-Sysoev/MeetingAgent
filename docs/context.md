...
- Добавлен гайд `docs/quality/QUERY_FEEDBACK_LOOP.md`: процесс логирования, разметки и коррекции первых реальных запросов (active-learning поверх RAG, без дообучения весов). Логирование запросов пока не реализовано в коде.
...
- Реализовать логирование запросов в `data/query_log.jsonl` в `scripts/04_query.py` и `scripts/09_chat.py` по формату из `docs/quality/QUERY_FEEDBACK_LOOP.md`.

...
- Добавить набор evaluation-вопросов для RAG и зафиксировать baseline качества numpy-поиска.
- Прогнать `docs/quality/rag_eval_questions.md` и заполнить baseline качества поиска.

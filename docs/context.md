...
- `configs/prompts/project_only_chat.md` задает project-only политику ответа;
...
- Выделен отдельный подпроект `Asu June Bot` для локального AI-агента по проекту ЦП УПКС. Документация создана в `docs/subprojects/asu-june-bot/`.

...
BUCKETS: tuple[RetrievalBucket, ...] = (
    ...
    RetrievalBucket(
        ...
        doc_types=("soi_ad",),
        query_markers=("active directory", "ldaps", "ldap", "групп", "ad", "учетн", "авторизац", "636", "project_role", "dn", "upn"),
        aliases=("СОИ AD", "Active Directory", "LDAP", "LDAPS", "порт 636", "группы AD", "project_role", "учетные записи", "синхронизация AD", "авторизация"),
        anchors=("OU=PROJECT", "project_role_*", "DN", "UPN", "member", "memberOf", "UserPrincipalName", "email", "cn", "группы Active Directory", "соответствие групп AD и ролей", "порт 636", "сервисные учетные записи"),

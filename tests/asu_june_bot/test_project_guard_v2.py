...
def test_false_clarify_project_queries_allowed() -> None:
    queries = [
        ...
        "Какие роли участвуют в сценариях фиксации и контроля устранения замечаний?",
        "Какие инфраструктурные компоненты перечислены в целевой технической архитектуре для продуктивного контура?",
        "Какие компоненты используются для очередей сообщений и обмена событиями в архитектуре?",
        "Какие требования к резервному копированию и восстановлению указаны в архитектурных документах?",
        "Какие проверки предусмотрены для формирования и подписания предписания?",
        "Какие входные данные требуются для проверки сценария работы с замечанием?",
        "Какие результаты ожидаются после выполнения сценариев по актам и предписаниям?",
        "Какие действия администратора описаны для подготовки инфраструктуры к развертыванию системы?",
        "Какие сервисные учетные записи или права доступа упоминаются в эксплуатационных материалах?",
        "Какие требования к резервному копированию описаны в эксплуатационной документации?",
        "Как в документах описан входной контроль материалов и оборудования?",
        "Какие замечания или статусы могут использоваться при работе с исполнительной документацией?",

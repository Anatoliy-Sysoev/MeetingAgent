...
DEFAULT_REFUSAL_MESSAGE = "Я отвечаю только по материалам проекта PRIVATE_SYSTEM. Вопрос не относится к проектной базе знаний."
...
class ProjectGuard:
    def __init__(self, refusal_message: str = DEFAULT_REFUSAL_MESSAGE):

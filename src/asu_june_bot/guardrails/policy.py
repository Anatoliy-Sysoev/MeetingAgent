...
REFUSAL_MESSAGE = "Я отвечаю только по материалам локальной проектной базы знаний. Вопрос не относится к проектному корпусу."
MIXED_SCOPE_MESSAGE = (
    "Запрос содержит проектную и внепроектную части. "
    "Я отвечаю только по материалам локальной проектной базы знаний. "
    "Уберите внепроектную часть запроса и повторите вопрос по документации проекта."
)
CLARIFY_MESSAGE = (
    "Не удалось однозначно определить, относится ли запрос к локальной проектной документации. "
...
IN_PROJECT_WITH_UNCLEAR_TAIL_MESSAGE = (
    "Запрос содержит проектную часть и дополнительную часть, которую нельзя надежно отнести к локальной проектной документации. "
...
META_ONLY_MESSAGE = (
    "Уточните проектный объект поиска: документ, модуль, требование, интеграцию или раздел проекта."
)

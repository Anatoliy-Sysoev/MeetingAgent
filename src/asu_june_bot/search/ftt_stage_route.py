...
def _build_ftt_glossary_source(rows: list[dict[str, Any]]) -> dict[str, Any] | None:
    ...
    if not parts:
        parts = [
            "ФТТ — Функционально-технические требования. В контексте проекта это документ проектной документации, содержащий функциональные и технические требования к ИС PRIVATE_SYSTEM."
        ]

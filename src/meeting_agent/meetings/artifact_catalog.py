...
ARTIFACT_CATALOG: list[dict[str, str]] = [
    ...
    {"artifact_key": "resolved_speaker_transcript", "title": "Curated speaker transcript",
     "stage": "resolve_speakers",
     "default_path": "transcript/resolved_speaker_transcript.jsonl", "content_type": "jsonl"},
    {"artifact_key": "resolved_speaker_transcript_txt", "title": "Curated transcript (text)",
     "stage": "resolve_speakers",
     "default_path": "transcript/resolved_speaker_transcript.txt", "content_type": "text"},
    {"artifact_key": "resolved_speaker_transcript_md", "title": "Curated transcript (Markdown)",
     "stage": "resolve_speakers",
     "default_path": "transcript/resolved_speaker_transcript.md", "content_type": "markdown"},

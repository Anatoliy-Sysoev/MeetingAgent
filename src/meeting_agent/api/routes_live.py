...
from meeting_agent.live_sessions import (
    LiveSessionConflict,
    LiveSessionError,
    LiveSessionNotFound,
...
from meeting_agent.live_sessions.store import LiveSessionStoreError
...
from meeting_agent.meetings.service import MeetingCardError, MeetingsService
...
def _get_service(request: Request) -> LiveSessionService:
    return get_app_state(request).live_session_service

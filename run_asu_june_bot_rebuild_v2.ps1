...
$LogPath = Join-Path $LogDir "asu_june_bot_rebuild_v2_$Stamp.log"
$DonePath = Join-Path $LogDir "asu_june_bot_rebuild_v2_$Stamp.done.txt"
$FailPath = Join-Path $LogDir "asu_june_bot_rebuild_v2_$Stamp.failed.txt"
...
try {
    Write-Step "Asu June Bot rebuild v2 started"
    ...
    Run-Step "asu_june_bot_extract_text_v2" @("scripts\asu_june_bot_extract_text_v2.py")
    Run-Step "asu_june_bot_build_chunks_v2" @("scripts\asu_june_bot_build_chunks_v2.py")

    Write-Step "Asu June Bot rebuild v2 completed successfully"
